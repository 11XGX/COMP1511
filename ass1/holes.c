// Author: Nathan Ellis
// Date: 30 April 2017
// Holes - This function uses a four-pass flood-fill algorithm to isolate holes and then checks for how many holes are present in the digit.
